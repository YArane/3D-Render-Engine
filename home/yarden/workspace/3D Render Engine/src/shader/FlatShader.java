...
public class FlatShader {
     ...
     * @param light
     */
    public static void shade2(String filename, Color color, Vector3f light){
        ModelData vao = OBJFileLoader.loadOBJ(filename); 
    ...
    /**
     * Returns a zBuffer with initial values set to -infinity
     * @return
     */
    protected static float[][] initZBuffer() {
        float[][] zBuffer = new float[Canvas.width][Canvas.height];
